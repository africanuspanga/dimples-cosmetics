  ...
  return (
    <nav
      className={cn(
        ...
        scrolled || isOpen ? "bg-background shadow-lg py-3" : "bg-transparent py-5",
      )}
    >
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden relative z-[60] text-foreground"
      ...
      <div
        className={cn(
          "lg:hidden fixed top-0 left-0 right-0 bottom-0 z-[55] bg-background transition-all duration-300 flex flex-col items-center justify-center gap-6",
